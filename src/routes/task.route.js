...
router.get("/:id", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Task.findById(req.params.id)];
            case 1:
                tasks = _a.sent();
                console.log(tasks);
                res.send(tasks);
...
router.post("/", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var _a, title, description, myTask;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, title = _a.title, description = _a.description;
                myTask = new Task({ title: title, description: description });
...
router.put("/:id", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, title = _a.title, description = _a.description;
                myTask = { title: title, description: description };
                return [4 /*yield*/, Task.findByIdAndUpdate(req.params.id, myTask)];
            case 1:
                _b.sent();
...
router.delete("/:id", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Task.findByIdAndRemove(req.params.id)];
            case 1:
                _a.sent();
